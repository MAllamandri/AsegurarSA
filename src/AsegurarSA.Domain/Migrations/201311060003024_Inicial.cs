    ...
    public partial class Inicial : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                c => new
                    {
                        GrabacionId = c.Int(nullable: false, identity: true),
                        PathGrabacion = c.String(),
                        Fecha = c.DateTime(nullable: false),
                        ClienteId = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.GrabacionId)
                .ForeignKey("dbo.Clientes", t => t.ClienteId, cascadeDelete: true)
                .Index(t => t.ClienteId);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Grabacions", "ClienteId", "dbo.Clientes");
            DropForeignKey("dbo.Eventos", "ClienteId", "dbo.Clientes");
            ...
            DropIndex("dbo.Grabacions", new[] { "ClienteId" });
            DropIndex("dbo.Eventos", new[] { "ClienteId" });
